...
if (prefix == "all_breedSample_site" | prefix == "all_breedPlusMissingSample_site"){
  shih_node <- getMRCA(all_tr, tip = c("SRR7780761","SRR7780763"))
...
if (prefix == "DLA-DQA1_breedSample" | prefix == "HLA-DQB1_breedSample") {
  p_final <- gheatmap(p3, dftree_heat_dis, offset = 0.05, width=0.1, colnames=F, colnames_position = "top", font.size = 3.5, colnames_offset_y = 0, color = NA) +
